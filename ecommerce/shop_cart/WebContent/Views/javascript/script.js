$(document).ready(function() {
		    ...
		    $.ajax({
		        url: 'http://localhost:8080/shop_cart/AllProductsServlet',
		        method: 'GET',
...
$(document).ready(function() {
			var url = 'http://localhost:8080/shop_cart/CategoriesServlet';
		    $.ajax({
		        url: url,
		        method: 'GET',
		        success: function(data) {
...
$(document).on('change', '#category', function() {
					...
					console.log(scv)
				     $.ajax({
				        url: 'http://localhost:8080/shop_cart/AllProdByIdServlet',
				        method: 'GET',
						data: {val:scv},
				    success: function(data) {
		            $('.row').empty();
